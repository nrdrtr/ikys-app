        ...
        >
            <Form className="form ui">
                <Card fluid>
                    ...
                    <Card.Content>
                        <label style={{ margin: "0.5em" }}> Programlama Dili</label>
                        <HrmsTextInput name="programmingLanguage" placeholder="programmingLanguage" />
                    </Card.Content>
                    <Card.Content>
                        <label style={{ margin: "0.5em" }}> Teknoloji Adı</label>
                        <HrmsTextInput name="technologyName" placeholder="technologyName" />
                    </Card.Content>
                    <Card.Content extra>
                        <Button type="submit" floated="right" icon labelPosition="right" color="green" >Güncelle<Icon name="add" /></Button>
                    </Card.Content>
                </Card>
            </Form>
        </Formik>
